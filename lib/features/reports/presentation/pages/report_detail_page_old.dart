...
class _ReportDetailPageState extends State<ReportDetailPage> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text('Konum: ${widget.report.address}'),
            const SizedBox(height: 4),
            Text('Oluşturulma: ${df.format(widget.report.createdAt)}'),
            const SizedBox(height: 12),
              ...
              Padding(
                ...
                child: FilterChip(
                  ...
                  onSelected: (_) {
                    context
                        .read<ReportBloc>()
                        .add(ReportStatusUpdated(widget.report.id, status));
                  },
                ),
              ),
          ],
  ...
  Widget _statusChip(ReportStatus status) {
      ...
      child: Text(
        ...
        style: TextStyle(
          ...
          fontWeight: FontWeight.bold,
                    ...
                    label: Text(
                      report.isFollowed ? 'Takipten Çık' : 'Takip Et',
                    ),
                  ),
                ),
              ],
  ...
  Widget _badgeRow(ReportEntity report) {
    return Row(
      mainAxisAlignment: MainAxisAlignment.spaceBetween,
      children: [_typeChip(report.type), _statusChip(report.status)],
    );
  }
  ...
  Widget _statusChip(ReportStatus status) {
    ...
    return Chip(
      ...
      label: Text(_statusLabel(status), style: TextStyle(color: color)),
    );
  }

  Widget _typeChip(ReportType type) {
